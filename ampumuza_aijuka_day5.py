...
def greet(*names):
    ...
    print("I am a software programmer")
    # Example usage:
greet("Shiela", "Alexandra", "Jordana")
...
user_info = get_user_info(name="paul", age=30, city="tokyo")

def pink_function(a, b, **kwargs):
    print(f"a: {a}, b: {b}")
    for key, value in kwargs.items():
        print(f"{key}: {value}")

# Example usage:
pink_function(1, 2, city="New York", job="Engineer")
