...
ampumuza_aijuka_day15 = Flask(__name__)
...
@ampumuza_aijuka_day15.route('/')
def index():
    return render_template('index.html', species_list=species_list)

@ampumuza_aijuka_day15.route('/add_species', methods=['GET', 'POST'])
def add_species():
...
if __name__ == '__main__':
    ampumuza_aijuka_day15.run(debug=True)
